// @generated by gen_entities.py — do not edit by hand.
// Mirrors the local Python stdlib html.entities.html5 table.
//
// Static table built at compile time (phf). No HashMap rebuild at
// runtime, single O(1) lookup, no SipHash. Keys are emitted in
// sorted order for deterministic builds.
use phf::phf_map;
